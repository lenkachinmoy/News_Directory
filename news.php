<?php
 ...
 $_SESSION['item'] = $_GET["item"];	//take product id from q parameter and store it into session
 $sql = "select * from admin_news where News_Id='$_SESSION[item]'";	//match id with database
?>
<html>
<head>
...
<div id="content">
   ...
   {
      echo "<tr>
	  <td><img src='".$row['Image']."' height='400' width='400' ></td>
	  <td>$row[News]</td>
	  </tr>";
   }
	?>
